...
\subsection{Redes   LPWAN:   Tecnologías   Habilitadoras   de   la   Agricultura
      Inteligente}
      ...
      \item \textbf{Variantes arquitectónicas}
            ...
            \begin{itemize}
                  ...
                  \item \textbf{Arquitectura híbrida multi-LPWAN:}  Permite  que
                        los dispositivos
                        tengan acceso a  múltiples  redes  LPWAN  (por  ejemplo,
...
\caption{Metodología de desarrollo  Kanban}
\end{figure}
...
\caption{Metodología de desarrollo basada en el modelo de prototipado}
\end{figure}
