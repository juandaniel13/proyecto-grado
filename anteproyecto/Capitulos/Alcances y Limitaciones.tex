...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{@{} >{\raggedright\arraybackslash}p{4cm} >{\raggedright\arraybackslash}X c @{}}
        ...
        \addlinespace
        Desarrollo web                                     & Plataforma funcional para el análisis y simulación visual de arquitecturas de redes LPWAN con agentes de IA generativa, orientada a la toma de decisiones en agricultura de precisión.                              & 1                 \\
        \addlinespace
