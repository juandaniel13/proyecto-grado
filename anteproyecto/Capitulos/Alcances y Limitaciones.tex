...
por el usuario o mediante bases de conocimiento de referencia. \subsection{No se implementará
    una LPWAN operativa.} El análisis comparativo será conceptual  y  basado  en
...
\subsection{Evaluación de alternativas de implementación y despliegue}

Se evaluarán dos alternativas para la implementación y despliegue del sistema. La primera consiste en entregar un prototipo funcional utilizando planes gratuitos y APIs de agentes de inteligencia artificial, evitando generar costos adicionales y asumiendo las limitaciones propias de dichos servicios. La segunda alternativa contempla el despliegue en el servidor institucional de la Universidad Distrital, sujeto a la disponibilidad y condiciones técnicas de dicha infraestructura.
