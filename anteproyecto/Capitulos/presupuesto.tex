...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X c c c c}
        ...
        \bottomrule
    \end{tabularx}
    \caption{Presupuesto detallado de Recursos Humanos}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X c c c}
        ...
        \bottomrule
    \end{tabularx}
    \caption{Presupuesto de Recursos Físicos e Infraestructura}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X r}
        ...
        \bottomrule
    \end{tabularx}
    \caption{Recursos de Software y Servicios Cloud bajo modalidad de capa gratuita}
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.6\textwidth}{>{\raggedright\arraybackslash}X r}
        ...
        \bottomrule
    \end{tabularx}
    \caption{Consolidado general del presupuesto del proyecto}
